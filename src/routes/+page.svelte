...
<section class="h-[80vh] chassis flex flex-col items-center justify-center relative">
	<Panel class="mb-10">
	...
	<button
		...
		class="w-32 h-32 rounded-full bg-signal text-white font-mono text-[10px] font-bold tracking-wider uppercase cursor-pointer transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 flex flex-col items-center justify-center gap-1"
...
<section bind:this={demoSection} class="min-h-screen flex">
